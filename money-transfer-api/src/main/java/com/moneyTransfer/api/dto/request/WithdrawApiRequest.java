...
public class WithdrawApiRequest {
    ...
    @Schema(description = "출금 사유", example = "현금 인출")
    @NotNull(message = "출금 사유는 필수입니다")
    @Size(min = 1, max = 200, message = "출금 사유는 1자 이상 200자 이하여야 합니다")
    private String description;

    public WithdrawApiRequest(String bankCode, String accountNo, BigDecimal amount, String description) {
