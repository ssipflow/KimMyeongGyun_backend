...
public class AccountController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "잘못된 요청 (중복 계좌, 유효성 검증 실패 등)", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "잘못된 요청 (잔액이 있는 계좌, 이미 삭제된 계좌 등)", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
